...
<## API Configuration ##>
Function Set-UcsSipAPIConnectionSetting
{
...
Function Get-UcsSipAPIConnectionSetting
{
  $OutputObject = 1 | Select-Object @{Name='Port';Expression={$Script:Port}},@{Name='Timeout';Expression={$Script:DefaultTimeout}},@{Name='Retries';Expression={$Script:DefaultRetries}}
  Return $OutputObject
}
